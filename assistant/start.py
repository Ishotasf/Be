...
**RynUbot [v{ultroid_version}](https://TatsuyaMusicStream), powered by @TatsuyaMusicStream**
"""
...
async def botstat(event):
    ...
    msg = """RynUbot Assistant - Stats Total Users - {}""".format(
    )
